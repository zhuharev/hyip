...
// nolint: dupl
func (qs PlanQuerySet) NameEq(name string) PlanQuerySet {
	return qs.w(qs.db.Where("name = ?", name))
}

// NameIn is an autogenerated method
// nolint: dupl
func (qs PlanQuerySet) NameIn(name string, nameRest ...string) PlanQuerySet {
...
// nolint: dupl
func (qs PlanQuerySet) NameNe(name string) PlanQuerySet {
	return qs.w(qs.db.Where("name != ?", name))
}

// NameNotIn is an autogenerated method
// nolint: dupl
func (qs PlanQuerySet) NameNotIn(name string, nameRest ...string) PlanQuerySet {
	iArgs := []interface{}{name}
	for _, arg := range nameRest {
		iArgs = append(iArgs, arg)
	}
...
// nolint: dupl
func (u PlanUpdater) SetName(name string) PlanUpdater {
	u.fields[string(PlanDBSchema.Name)] = name
	return u
}
